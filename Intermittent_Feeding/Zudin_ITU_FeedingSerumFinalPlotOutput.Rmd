...
for (i in 1:length(list_fitMetabs)) {
  ...
  volcanoes_plot <- ggplot(
    ...
    geom_jitter(width = 0.06, alpha = 0.8) +
    ...
    scale_colour_manual(values = c("red", "darkgray", "blue", "black")) +
...
# export as PDFs
ggexport(plotsArranged, filename="/Users/mdzdw/WorkFolders/ResearchWork/PROJECT_ExtCollab/Zudin_ICU/Non_Normalised_ITUFeeding/FINAL_Data/AllMetabsFinal/EDA_figs/Volcano_Plots2.pdf")
